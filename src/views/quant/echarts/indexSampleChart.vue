<template>
  <div style="width:80%;height:100%;" id="house_deal_con"></div>
</template>

<script>
import echarts from 'echarts'
export default {
    name: 'indexSampleChart',
    props: ['statisticData'],
    data () {
        return {
            maxData: 90,
    ...
    mounted () {
        const option = {
            ...
            yAxis: {
                data: ['399812-养老产业', '000922-中证红利', '000010-上证180', '000300-沪深300', '000905-中证500', '000852-中证1000'],
                inverse: true,
                axisTick: { show: false },
                axisLine: { show: false },
                axisLabel: {
